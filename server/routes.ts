...
router.get("/system/health", (req, res) => {
  return res.json({
    ...
    envs: {
      ...
      SCENE_ID_BULLETIN_SKETCH: process.env.SCENE_ID_BULLETIN_SKETCH,
      DROPPABLE_ASSETS_BULLETIN_SKETCH: process.env.DROPPABLE_ASSETS_BULLETIN_SKETCH,
      SCENE_ID_CHALK: process.env.SCENE_ID_CHALK,
      ANCHOR_ASSET_IMAGE_CHALK: process.env.ANCHOR_ASSET_IMAGE_CHALK,
      SCENE_ID_ART: process.env.SCENE_ID_ART,
      ANCHOR_ASSET_IMAGE_ART: process.env.ANCHOR_ASSET_IMAGE_ART,
      SCENE_ID_HARVEST: process.env.SCENE_ID_HARVEST,
      ANCHOR_ASSET_IMAGE_HARVEST: process.env.ANCHOR_ASSET_IMAGE_HARVEST,
      SCENE_ID_CAR: process.env.SCENE_ID_CAR,
      ANCHOR_ASSET_IMAGE_CAR: process.env.ANCHOR_ASSET_IMAGE_CAR,
      SCENE_ID_PARKING: process.env.SCENE_ID_PARKING,
      DROPPABLE_TEXT_PARKING: process.env.DROPPABLE_TEXT_PARKING,
      SCENE_ID_GALLERY: process.env.SCENE_ID_GALLERY,
      ANCHOR_ASSET_IMAGE_GALLERY: process.env.ANCHOR_ASSET_IMAGE_GALLERY,
