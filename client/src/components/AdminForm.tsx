  ...
  return (
    <>
      ...
      {showChangeSceneModal && (
        <Modal buttonText="Replace" onConfirm={confirmSubmit} setShowModal={setShowChangeSceneModal} text="This will remove this instance of the Bulletin Board and all associated data permanently and then replace it with your newly selected scene. Are you sure you'd like to continue?" title="Replace Scene in World" />
      )}

      {showRemoveModal && (
        <Modal buttonText="Remove" onConfirm={removeBulletinBoard} setShowModal={setShowRemoveModal} text="This will remove this instance of the Bulletin Board and all associated data permanently. Are you sure you'd like to continue?" title="Remove from World" />
      )}
